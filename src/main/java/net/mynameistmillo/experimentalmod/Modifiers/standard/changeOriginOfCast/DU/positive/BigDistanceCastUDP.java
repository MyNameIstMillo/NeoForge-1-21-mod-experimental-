...
public class BigDistanceCastUDP extends Item implements IModifier {

    public BigDistanceCastUDP(Properties properties) {
        super(properties);
    }
    ...
    public ItemStack applyChanges(Level level, ItemStack stack) {
        ...
        float displacement = stats.get(StatsF.SHIFT_UD) + 4.5f;
