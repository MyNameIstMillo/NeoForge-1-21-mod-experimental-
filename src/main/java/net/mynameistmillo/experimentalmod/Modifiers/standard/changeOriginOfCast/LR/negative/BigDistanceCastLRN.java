...
public class BigDistanceCastLRN extends Item implements IModifier {

    public BigDistanceCastLRN(Properties properties) {
        super(properties);
    }
    ...
    public ItemStack applyChanges(Level level, ItemStack stack) {
        ...
        float displacement = stats.get(StatsF.SHIFT_LR) - 4.5f;
