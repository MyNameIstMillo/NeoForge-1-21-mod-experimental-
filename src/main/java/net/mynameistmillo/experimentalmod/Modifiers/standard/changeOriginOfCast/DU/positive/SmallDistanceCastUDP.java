package net.mynameistmillo.experimentalmod.Modifiers.standard.changeOriginOfCast.DU.positive;
...
public class SmallDistanceCastUDP extends Item implements IModifier {

    public SmallDistanceCastUDP(Properties properties) {
        super(properties);
    }
    ...
    public ItemStack applyChanges(Level level, ItemStack stack) {
        ...
        float displacement = stats.get(StatsF.SHIFT_UD) + 1.5f;
