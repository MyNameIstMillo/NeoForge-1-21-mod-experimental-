package net.mynameistmillo.experimentalmod.Modifiers.standard.changeOriginOfCast.FB.positive;
...
public class SmallDistanceCastFBP extends Item implements IModifier {

    public SmallDistanceCastFBP(Properties properties) {
        super(properties);
    }
    ...
    public ItemStack applyChanges(Level level, ItemStack stack) {
        ...
        float displacement = stats.get(StatsF.SHIFT_FB) + 1.5f;
