...
public class infestationSingle extends Item implements IProjectile {
    ...
    public infestationSingle(Properties properties) {
        ...
        this.baseStatsF.set(StatsF.FORCE_Y, 0.005f);
        ...
        this.baseStatsF.set(StatsF.SHIFT_FB, 4.0f);

        this.baseStatsF.set(StatsF.NORMAL_DAMAGE, 0.3f);

        this.baseStatsI = new ProjStatsI();
        this.baseStatsI.set(StatsI.LIFETIME, 120);
    ...
    public Entity spawnProj(Level level,
        ...
        Entity e = Helper.spawnProjBasic(level, pos, caster, normal, wandStack, thisProj,
                "infestation_single", 0.25f, 0.25f);
        assert e != null;
