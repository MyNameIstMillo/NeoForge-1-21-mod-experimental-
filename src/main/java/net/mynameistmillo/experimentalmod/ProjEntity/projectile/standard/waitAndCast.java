...
public class waitAndCast extends Item implements IProjectile {

    public waitAndCast(Properties properties) {
        super(properties);
        this.baseStatsF = new ProjStatsF();
        this.baseStatsF.set(StatsF.SPEED, 0.02f);
        ...
        this.baseStatsI.set(StatsI.TRIGGER_TYPE , TriggerType.EXPIRE.getId());
